  ...
  return (
    <section className="relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -right-40 top-20 h-72 w-72 rounded-full bg-sky/10 blur-3xl" />
      </div>
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 px-4 pb-24 pt-16 md:flex-row md:pt-24">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/70">
            ...
            Human-centered AI, delivered with care
          </span>

          <h1 className="mt-5 text-4xl font-semibold tracking-tight md:text-5xl lg:text-6xl">
            Software care that keeps your business confident{" "}
          ...
          <p className="mt-5 max-w-xl text-sm text-white/70 md:text-base">
            Guidelight Labs turns technical complexity into dependable, scalable
            software ecosystems. We stand beside you to design AI-powered
            solutions that honour your processes, empower your people, and move
          ...
          <div className="mt-7 flex flex-wrap items-center gap-4">
            <a
              href="#contact"
              className="rounded-full bg-mint px-5 py-2 text-sm font-semibold text-bgDark shadow-lg shadow-mint/30 hover:bg-sky transition-colors"
            >
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs text-white/50">
            <span className="rounded-full border border-white/10 px-3 py-1">
              Strategic discovery & co-creation
            </span>
            <span className="rounded-full border border-white/10 px-3 py-1">
              Secure, resilient platforms
            </span>
            <span className="rounded-full border border-white/10 px-3 py-1">
              Continuous care beyond launch
            </span>
          </div>
        </motion.div>
          ...
          <div className="relative mx-auto h-80 w-80 max-w-full">
            <div className="card-glass absolute inset-8 flex flex-col items-center justify-center">
              ...
              <p className="mt-2 text-center text-sm text-white/70">
                We steward digital products that bring clarity, trust and calm
                to your teams and customers.
              </p>
              <p className="mt-4 text-xs text-mint">
                “Steadfast software, human-first guidance.”
              </p>
            </div>
